...
export default function NewCard() {
  return (
    <div className="min-h-dvh px-5 py-8 max-w-xl mx-auto">
      ...
      <h1 className="mt-4 text-2xl font-bold">QR Card</h1>
      ...
      <div className="mt-5 qrlife-card rounded-2xl overflow-hidden">
        <div className="px-4 py-3 bg-[color:var(--qrlife-purple)] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-2xl bg-white/15 flex items-center justify-center">+</div>
        ...
        <div className="p-4 space-y-3">
          <input className="w-full rounded-xl bg-white/10 border border-white/10 px-4 py-3" placeholder="QR Card Name" />
          ...
          <div className="pt-2">
            ...
            <div className="mt-2 text-sm text-white/70">(Link list will appear here)</div>
          </div>
      ...
      <div className="mt-6 text-xs text-white/60">
        Note: URL safety check is in WARN mode until the Safe Browsing API key is added.
      </div>
    </div>
  );
}
